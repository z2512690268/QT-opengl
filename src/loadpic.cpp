...
Loadpic::Loadpic(QWidget *parent) : QWidget(parent)
{
    ...
    // slots
    connect(button, &QPushButton::clicked, this, &Loadpic::loadPicFromFS);
    connect(button2, &QPushButton::clicked, this, &Loadpic::loadPicFromFS2);
...
void Loadpic::button3slot() {
    qDebug() << "Loadpic::button3slot()";
}